    ...
    <main>
          ...
          <section className="how">
            ...
            <div className="steps">
              ...
              <div>
                ...
                <p>
                  Browse nearby shops that work on your type of equipment.
                </p>
              </div>
      ...
      {step === 'results' && (
        <section className="results">
          ...
          <p>
            Demo listings shown for the MVP.
            Live businesses will be added during launch.
          </p>
          ...
          <div className="formWrap">
            {!submitted ? (
              <>
                ...
                <p>
                  Send your repair request to the shop.
                  They can confirm availability and next steps.
                </p>
              ...
              <div className="success">
                ...
                <p>
                  ...
                  {selected?.name}. In the production version,
                  the shop will receive this instantly and contact
                  you to confirm.
                </p>
      ...
      {step === 'list' && (
        <section className="formPage darkPage">
          ...
          <div className="formWrap darkForm">
            ...
            <p>
              Join FixScout's launch network.
              Create your shop listing and receive repair appointment
              requests from local equipment owners.
            </p>
            ...
            <button
              ...
              onClick={() =>
                alert(
                  'Thanks! This demo form is ready to connect to the production database.'
                )
              }
            >
      ...
      <footer>
        ...
        <small>
          © 2026 FixScout. MVP demonstration.
        </small>
      </footer>
    </main>
  );
